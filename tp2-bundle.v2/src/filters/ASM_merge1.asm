...
ASM_merge1:
	...
	mov rax, r12
	mul r15
	shr rax, 2 ;dividimos por 4 la cantidad de pixeles, ya que se traen de a 4 pixeles
	xor r12, r12
	mov r12, rax ;cantidad de llamadas a memoria en r12
	...
	.ciclo:
		...
		;traemos 4 pixeles de una imagen
		...
		;traemos 4 pixeles de otra imagen
		movdqu xmm10, [r14] 	;xmm10=b|g|r|a|b|g|r|a|b|g|r|a|b|g|r|a|
		pshufb xmm10, xmm12  	;xmm10=b|b|b|b|g|g|g|g|r|r|r|r|a|a|a|a
		movdqu xmm11, xmm10
		...
		mulps xmm12,xmm9       ; multiplicamos por 1-value
		...
		mulps xmm14,xmm9       ; multiplicamos por 1-value
